...
mkdir('data/txt');
mkdir('data/api');
$API_KEY= '8109867456:AAEiRD3ml9S12LhTXuahU8gpZXNSIzibubQ';
...
$chall = "A_R_L_M1";
$useradmin = "X_O_RE";
$sim =-2178843657; #القناة الرسمية
$PAY =-2173084731; #الارقام المكتملة
$ess =-2351366843; #عمليات شراء الارقام
$eer =-2435838210; #اشعارات الايميلات وتحويل الروبل
if($chat_id==7218299328){
$sudo=$chat_id;
}elseif($chat_id==7218299328){
$sudo=$chat_id;
}else{
$sudo==7218299328;
}
...
*- في بوت SAERO SMS SMS الممكس* ؛ البوت الأفضل على التليجرام والذي يقوم بتوفير *خدمات الأرقام الوهمية* ل مواقع السوشيال ميديا مثل *التيليجرام والواتساب والتويتر وغيره* 👾
...
'text'=>"
👨‍✈️ *⁞ مرحبا بك* [$first](tg://user?id=$id) ؛
🏛 *⁞ هذه تفاصيل حسابك في بوت. SAERO SMS SMS الممكس* ⬇️
...
👨‍💻 فريق دعم SAERO SMS : *@$useradmin*
",
'parse_mode'=>"MarkDown",
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'💭 - تواصل بـ فريق دعم SAERO SMS ↖️','url'=>"tg://user?id=$sudo"]],
...
'message_id'=>$message_id,
'text'=>"
🧑‍✈️ *- أهلا بك عزيزي العميل* في قسم وكلاء البوت الرسميين في بوت *SAERO SMS SMS الممكس* ☑️
",
'parse_mode'=>"MarkDown",
'reply_markup'=>($keyboad),
]);
